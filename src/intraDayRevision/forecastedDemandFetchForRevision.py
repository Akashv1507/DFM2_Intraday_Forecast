...
class ForecastedDemandFetchForRevisionRepo():
    ...
    def fetchForecastedDemandForRevision(self, start_Time: dt.datetime, end_Time: dt.datetime, entityTag:str, avgBiasError: float) -> List[Tuple]:
        ...
        # currdate = dt.datetime.strptime("2020-12-06 22:40:40", '%Y-%m-%d %H:%M:%S').replace(hour =0 ,minute =0,second=0, microsecond=0)
        ...
        # if startExceptionTime <= dt.datetime.strptime("2020-12-06 22:40:40", '%Y-%m-%d %H:%M:%S') < endExceptionTime:
