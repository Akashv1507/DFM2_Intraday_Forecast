        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    del_sql = "DELETE FROM dfm2_revisionwise_error_store WHERE date_key = :1 and entity_tag=:2 and revision_no =:3"
                    cur.executemany(del_sql, existingRows)
                    insert_sql = "INSERT INTO dfm2_revisionwise_error_store(date_key, ENTITY_TAG, revision_no, mae, mape, rmse, rmse_percentage) VALUES(:1, :2, :3, :4, :5, :6, :7)"
