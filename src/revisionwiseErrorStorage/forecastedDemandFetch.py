    ...
    def fetchForecastedDemand(self, startDate:dt.datetime, endDate:dt.datetime, revisionNo : str) ->pd.core.frame.DataFrame:
        ...
        try:
            ...
            try:
                ...
                fetch_sql = "SELECT time_stamp, entity_tag, forecasted_demand_value FROM dfm2_forecast_revision_store WHERE time_stamp BETWEEN TO_DATE(:start_time,'YYYY-MM-DD HH24:MI:SS') and TO_DATE(:end_time,'YYYY-MM-DD HH24:MI:SS') and revision_no = :rNo ORDER BY entity_tag, time_stamp"
