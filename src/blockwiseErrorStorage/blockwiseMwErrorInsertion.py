        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    del_sql = "DELETE FROM dfm2_mw_error_store WHERE time_stamp = :1 and entity_tag=:2 and revision_no =:3"
                    cur.executemany(del_sql, existingRows)
                    insert_sql = "INSERT INTO dfm2_mw_error_store(time_stamp, ENTITY_TAG, revision_no, mw_error, percentage_mw_error) VALUES(:1, :2, :3, :4, :5)"
